...
import (
	...
	"github.com/istiofy/istiofy/internal/gateway"
	"github.com/istiofy/istiofy/internal/gateway/grpc"
...
func GetServerCommand() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&cfgFile, "config", "./config/config.yaml", "config file (default is $HOME/.istiofy.yaml)")
